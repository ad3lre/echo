        ...
        VStack(alignment: .leading, spacing: 24) {
          HStack(alignment: .top, spacing: 16) {
            VStack(alignment: .leading, spacing: 6) {
              ...
              Text("Search Echo or start with a few people you might know.")
          ...
          VStack(alignment: .leading, spacing: 9) {
            Text(searchText.isEmpty ? "SUGGESTED PEOPLE" : "RESULTS")
...
private struct EchoFriendCandidateRow: View {
  ...
  var body: some View {
    HStack(spacing: 12) {
      ...
      .accessibilityLabel(didSend ? "Friend request sent" : "Add \(candidate.name)")
    }
