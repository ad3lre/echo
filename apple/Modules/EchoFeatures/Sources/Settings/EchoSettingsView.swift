...
struct EchoSettingsView: View {
  ...
  private let sections: [EchoSettingsSection] = [
    .init(
      ...
      rows: [
        .init(
          route: .account, subtitle: "Sign-in details, security, and sessions",
          icon: "person.badge.key.fill", tint: .purple),
        .init(
          route: .friends, subtitle: "Friend and message request preferences",
          icon: "person.2.fill", tint: .blue),
        .init(
          route: .notifications, subtitle: "Alerts, badges, sounds, and mentions",
          icon: "bell.fill", tint: .orange),
        .init(
          route: .sounds, subtitle: "Master audio and per-sound controls",
          icon: "speaker.wave.2.fill", tint: .pink),
        .init(
          route: .dataPrivacy, subtitle: "Export your account data",
    ...
    .init(
      ...
      rows: [
        .init(
          route: .style, subtitle: "Tune Echo’s look and spacing", icon: "paintbrush.fill",
          tint: .cyan),
        .init(
          route: .accessibility, subtitle: "Readability, motion, and interaction",
          icon: "figure.wave", tint: .green),
        .init(
          route: .voiceVideo, subtitle: "Devices and call behavior", icon: "video.fill",
          tint: .purple),
        .init(
          route: .timeLanguage, subtitle: "Language, region, and timestamps", icon: "globe",
          tint: .mint),
        .init(
          route: .advanced, subtitle: "Optional developer controls", icon: "slider.horizontal.3",
          tint: .gray),
      ]),
    .init(
      title: "External apps",
      rows: [
        .init(
          route: .discord, subtitle: "Link Discord for profile and identity import", icon: "link",
          tint: .indigo),
        .init(
          route: .google, subtitle: "Link Google for sign-in and YouTube", icon: "g.circle.fill",
          tint: .blue),
        .init(
          route: .youtube, subtitle: "Connect a channel for live broadcasts",
    ...
    .init(
      ...
      rows: [
        .init(
          route: .echoPlus, subtitle: "Membership benefits and perks", icon: "sparkles",
          tint: .purple
        ),
        .init(
          route: .subscriptions, subtitle: "Plans, renewals, and invoices",
    ...
    .init(
      ...
      rows: [
        .init(
          route: .termsPolicies, subtitle: "Privacy, terms, and community guidelines",
          icon: "doc.text.fill", tint: .gray),
        .init(
          route: .reportAbuse, subtitle: "Report spam, harassment, or violations",
          icon: "exclamationmark.shield.fill", tint: .red),
        .init(
          route: .formattingGuide, subtitle: "How Echo formats messages", icon: "textformat",
          tint: .cyan),
      ]),
  ]
    ...
    VStack(spacing: 16) {
      ...
      HStack(spacing: 10) {
        ...
        TextField("Search settings", text: $searchText)
          ...
          .submitLabel(.search)
          .accessibilityLabel("Search Echo settings")
...
private struct EchoSettingsEmptyState: View {
  ...
  var body: some View {
    VStack(spacing: 12) {
      ...
      Text("Echo couldn’t find anything matching “\(query)”")
  ...
  var body: some View {
    HStack(spacing: 14) {
      ...
      VStack(alignment: .leading, spacing: 4) {
        ...
        Text(profile.map { "Tune Echo for \($0.name)" } ?? "Make Echo feel like yours.")
