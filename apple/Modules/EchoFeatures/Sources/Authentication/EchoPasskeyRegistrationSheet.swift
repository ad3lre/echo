...
struct EchoPasskeyRegistrationSheet: View {
  ...
  var body: some View {
    EchoSettingsSheetShell(
      title: "Add passkey",
      description: "Use Face ID, Touch ID, or your device passcode to sign in faster.",
      ...
      content: {
        ...
        EchoSettingsSheetField(
          title: "Current password", icon: "lock.fill", tint: .orange, value: $password,
          isSecure: true)
        EchoSettingsSheetField(
          title: "Authenticator code (if enabled)", icon: "number.square.fill", tint: .blue,
          value: $totpCode, keyboard: .numberPad)
        EchoSettingAction(
          title: isWorking ? "Waiting for Face ID…" : "Add passkey",
          subtitle: "Register this device as a secure Echo sign-in",
