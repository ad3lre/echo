 ...
 *
 * Run: npx ts-node src/tests/echo.rbac.bench.ts
 */
...
import { createTraceCollector } from '../domain/echoPermissionTrace';
import type { FoldTraceContext } from '../domain/echoPermissionTrace';
