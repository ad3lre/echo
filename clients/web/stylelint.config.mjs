  ...
  overrides: [
    ...
    /* Legacy SCSS entrypoints still carry raw palette literals; token migration tracked separately. */
    {
      files: [
        ...
        'src/features/member-profile/expandedProfileShared.scss',
        ...
        'src/features/voice/wordline/wordlineActivity.scss',
        'src/features/voice/ticTacToe/ticTacToeActivity.scss',
