...
import type { VcModerateAction } from '@/features/voice/CallView.vue';
...
import { getVoiceChannelUserLimitUi } from '@/features/voice/voiceChannelUserLimit';
import {
...
} from '@/features/voice/requestStageSpeak';
