...
} from '@/features/member-profile/profileBannerGradientFromImage';
import {
  ProfileBannerMedia,
  ProfileBioText,
} from '@/features/member-profile/widgets';
import BannerRepositionModal from '@/features/server-settings/BannerRepositionModal.vue';
    ...
    <div class="settings-card rounded-2xl p-6">
      ...
      <div class="banner-effects-grid">
        <button
          ...
          :disabled="bannerEffectsPersisting"
          :aria-busy="bannerEffectsPersisting"
