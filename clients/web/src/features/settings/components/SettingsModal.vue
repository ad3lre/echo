...
import { useCompactSettingsModalGestures } from '@/features/settings/useCompactSettingsModalGestures';
import type { PersonalNotificationSettings } from '@/features/settings/notificationPreferences';
import type {
  SettingsGroupLabel,
  SettingsSection,
...
import { sessionUserDisplayName } from '@/features/member-profile/memberProfiles';
import { normalizeBannerColorForForm } from '@/features/member-profile/profileBannerGradientFromImage';
...
watch(
  () => ({
    ...
    solidGlassSurfaces: form.accessibilitySettings.solidGlassSurfaces,
...
watch(
  ...
  (open) => {
    ...
    form.accessibilitySettings.solidGlassSurfaces = a11y.solidGlassSurfaces;
