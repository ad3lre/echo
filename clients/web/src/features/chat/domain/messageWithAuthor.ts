...
import { resolveMessageAuthorPresenceStatus } from '@/features/layout/presence';
import { normalizeMessageAttachments } from '@/features/chat/composables/normalizeMessageAttachments';
