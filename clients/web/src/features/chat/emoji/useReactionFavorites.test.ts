...
vi.mock('@/features/chat/emoji/twemoji', () => ({
...
} from '@/features/chat/emoji/useReactionFavorites';
import { syncRecentlyUsedFromStorage } from '@/features/chat/emoji/useRecentlyUsedEmojis';
