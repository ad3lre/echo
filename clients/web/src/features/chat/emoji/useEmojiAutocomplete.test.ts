...
vi.mock('@/features/chat/emoji/useEmojiSearchIndex', async (importOriginal) => {
  const actual =
    await importOriginal<
      typeof import('@/features/chat/emoji/useEmojiSearchIndex')
    >();
  return {
    ...actual,
...
vi.mock('@/features/chat/emoji/useAppIconSearch', () => ({
