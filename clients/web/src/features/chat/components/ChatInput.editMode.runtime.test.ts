...
vi.mock('@/features/chat/composables/useComposerState', () => ({
  useComposerState: () => ({
    content: mockContent,
...
vi.mock('@/features/chat/composables/usePendingMedia', () => ({
  usePendingMedia: () => ({
    pendingImages: ref([]),
    pendingVideos: ref([]),
    pendingAudios: ref([]),
...
vi.mock('@/features/chat/composables/usePendingVideoEagerUpload', () => ({
  usePendingVideoEagerUpload: vi.fn(),
}));

vi.mock('@/features/chat/composables/useChatSend', () => ({
...
vi.mock('@/features/chat/useChatPermissions', () => ({
  useChatPermissions: () => ({
...
vi.mock('@/features/chat/composables/usePopoutStack', () => ({
  usePopoutStack: () => ({
...
vi.mock('@/features/chat/emoji/useServerEmojiLibrary', () => ({
...
vi.mock('@/features/chat/emoji/useEmojiAutocomplete', () => ({
...
vi.mock('@/features/chat/composables/useMentionAutocomplete', () => ({
...
vi.mock('@/features/chat/composables/useChannelAutocomplete', () => ({
...
vi.mock('@/features/layout/useCompactShell', () => ({
  useCompactShell: () => ({ isCompactShell: ref(true) }),
}));

vi.mock('@/features/settings/themeStore', () => ({
  useThemeStore: () => ({
