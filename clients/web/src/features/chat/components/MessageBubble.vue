...
import { useCustomEmojiImgLoadRecovery } from '@/features/chat/composables/useCustomEmojiImgLoadRecovery';
import { requestAppConfirmFromContextMenu } from '@/features/layout/failures/appDialogs';
import PausedGifAvatar from '@/components/PausedGifAvatar.vue';
import { useShiftKey } from '@/features/chat/composables/useShiftKey';
import {
  getPopoutAnchorRect,
...
import { copyImageFromUrl } from '@/features/chat/copyToClipboard';
import { plainTextFromEchoContentJson } from '@/features/chat/editor/echoContentJsonPlainText';
import { plainTextForRawMessage } from '@/features/chat/domain/messageDisplayPlain';
...
import { linkTokenMessage } from '@/features/layout/ids/idTokens';
import { useContextMenuPosition } from '@/features/layout/useContextMenuPosition';
...
import { defaultQuickReactionFavorites } from '@/features/chat/emoji/useReactionFavorites';
...
import { applyEmbedTitlesToMessageContent } from '@/features/chat/composables/embedLinkLabels';
import { mergeEchoJumpEmbedsForMessage } from '@/features/chat/composables/messageJumpContentParse';
import {
  COMPOSER_INSERT_USER_MENTION_KEY,
  type InsertUserMentionFn,
} from '@/features/chat/chatComposerContext';
import { isMessageAuthorOffline } from '@/features/chat/composables/isOfflinePresence';
import { formatShortTime } from '@/features/chat/formatTimestamp';
import {
  loadTimeLanguagePreferences,
  timeLanguagePrefsEpoch,
} from '@/features/settings/timeLanguagePreferences';
import type { MagicTimeRenderContext } from '@/features/chat/markdown/messageContentSegments';
import { useAnchoredFloatingPosition } from '@/features/chat/composables/useAnchoredFloatingPosition';
...
import { isOutboundMessageSendPending } from '@/features/chat/send/deferredMediaOutboundSend';
import { useEchoWorkspace } from '@/features/layout/echoWorkspace/useEchoWorkspace';
import { resolveGuildMemberDisplayName } from '@/features/member-profile/resolveGuildMemberDisplayName';
