...
import { extractMarkdownHeadingToc } from '@/features/chat/markdown/useMarkdown';
...
import { getParentChannelIdOrNull } from '@/features/forums/forumPostChannel';
...
import { extractChatImageSearchSeeds } from '@/features/chat/composables/imageSearchSeedKeywords';
import { isLikelyGifImageUrl } from '@/features/chat/isGifImageUrl';
import { useEchoChatBottomChromeReporter } from '@/features/layout/useEchoChatBottomChromeReporter';
import SelfAssignableRolesWidget from '@/features/self-roles/SelfAssignableRolesWidget.vue';
import EmojiInspectCard from '@/features/chat/components/EmojiInspectCard.vue';
import { useEmojiInspect } from '@/features/chat/emoji/useEmojiInspect';
import {
