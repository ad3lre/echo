...
import type * as SocialApi from '@/features/layout/echoWorkspace/workspaceSocialHydrate';
...
vi.mock(
  '@/features/layout/echoWorkspace/workspaceSocialHydrate',
...
vi.mock('@/features/layout/echoWorkspace/workspacePersistence', () => ({
...
} from '@/features/layout/echoWorkspace/workspaceSocialHydrate';
import { saveEchoWorkspaceToCache } from '@/features/layout/echoWorkspace/workspacePersistence';
import {
  invalidateInFlightEchoWorkspaceSocialRefresh,
  runEchoWorkspaceHydrateFromApi,
  runEchoWorkspaceSocialRefreshFromApi,
} from '@/features/layout/echoWorkspace/workspaceEchoHydrateFromApi';
