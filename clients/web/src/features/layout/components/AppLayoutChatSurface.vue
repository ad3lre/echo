...
import type { FilterKey, HasType } from '@/features/chat/composables/useSearch';
import { emitChatSwitchEvent } from '@/features/layout/chatSwitchPerfTrace';
import { useChatCustomEmojiResolvers } from '@/features/chat/emoji/useChatCustomEmojiResolvers';
...
/** Search panel uses a slim channel shape; server/voice/DM children accept wider summaries via their own props. */
  ...
  >
    ...
    <div class="relative isolate flex min-h-0 min-w-0 flex-1 flex-col">
      ...
      <AppLayoutVoiceSection
        ...
        :mention-roles="chatCtx.rolesForMentionAutocomplete"
        ...
        :fill-image-slot="chatCtx.fillImageSlot"
        ...
        :wordline-view="chatCtx.wordlineView"
        :submit-wordline-guess="chatCtx.submitWordlineGuess"
        :set-wordline-mode="chatCtx.setWordlineMode"
      ...
      <AppLayoutForumSection
        ...
        :on-fill-image-slot="chatCtx.fillImageSlot"
      ...
      <div v-else class="flex min-h-0 min-w-0 flex-1 flex-col">
        <AppLayoutDmSection
          ...
          "
          :resolve-dm-mention-notification-row-preview="
            chatCtx.resolveDmMentionNotificationRowPreview
          "
