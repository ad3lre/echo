...
const MemberProfilePopout = defineAsyncComponent(
  () => import('@/features/member-profile/components/MemberProfilePopout.vue'),
);
const SelfProfilePopout = defineAsyncComponent(
  () => import('@/features/member-profile/components/SelfProfilePopout.vue'),
);
const ExpandedProfileModal = defineAsyncComponent(
  () => import('@/features/member-profile/components/ExpandedProfileModal.vue'),
);
...
const EventDetailModal = defineAsyncComponent(
  () => import('@/features/server-events/EventDetailModal.vue'),
);
