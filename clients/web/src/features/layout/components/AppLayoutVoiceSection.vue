...
const CallView = defineAsyncComponent(
  () => import('@/features/voice/CallView.vue'),
);
...
const props = defineProps<{
  ...
  /** Connected guild server/voice/stage channel (LiveKit session), if any. */
  ...
  /** Join the guild server/voice/stage channel (used when entering stage from the lobby). */
...
watchEffect(() => {
  ...
  void import('@/features/voice/CallView.vue');
