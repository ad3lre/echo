...
import type { useEchoWorkspace } from '@/features/layout/echoWorkspace/useEchoWorkspace';
...
import type { useEchoHistory } from '@/features/chat/composables/useEchoHistory';
...
import type {
  ...
  VideoQualityPreset,
} from '@/features/voice/useLiveKitVoiceRoom';
import type {
...
import type { FilterChip } from '@/features/chat/composables/useSearch';
...
import type { DmIncomingRailAvatar } from '@/features/layout/composables/dm/useAppLayoutDmRailUnread';
...
export interface AppLayoutControllerContext {
  ...
  allChannels: ComputedRef<
    import('@/features/chat/search/messageSearchCore').ChannelListEntry[]
  >;
  ...
  joinServerConfirmPreview: Ref<JoinServerConfirmPreview | null>;
  ...
  serverApplicationPayload: Ref<ServerApplicationModalPayload | null>;
