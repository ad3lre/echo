 ...
 * and template contracts are unchanged. UI-error CTA and Discord profile-import
 * prompt live in useAppLayoutInfoBannersProvide / useAppLayoutCoreShellProvide.
 */
