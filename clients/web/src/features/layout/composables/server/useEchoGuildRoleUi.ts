...
import { pickEchoMemberListSectionRole } from '@/features/member-profile/memberProfiles';
...
import { canMutateEchoMemberRole } from '@/features/layout/composables/members/echoMemberRoleMutateGate';
  ...
  const memberListRoleManagement = computed(() => {
    ...
    return {
      ...
      assignableRoles: echoRoleCatalog.value.map((r) => ({
        ...
        isMembers: r.isMembers ?? r.isEveryone,
        isEveryone: r.isEveryone ?? r.isMembers,
        position: r.position,
