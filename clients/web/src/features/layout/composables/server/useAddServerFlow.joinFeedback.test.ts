...
vi.mock(
  '@/features/layout/composables/guest/guestJoinExploreBlockedDialog',
  async (importOriginal) => {
    const actual =
      await importOriginal<
        typeof import('@/features/layout/composables/guest/guestJoinExploreBlockedDialog')
      >();
    return {
      ...actual,
...
vi.mock(
  '@/features/layout/failures/controllerMissingAction',
  async (importOriginal) => {
    const actual =
      await importOriginal<
        typeof import('@/features/layout/failures/controllerMissingAction')
      >();
    return {
      ...actual,
