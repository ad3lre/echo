...
import { createSocketAdapter } from '@/features/layout/realtime/socketAdapter';
import { nextEchoClientSnowflakeId } from '@/features/layout/ids/echoClientSnowflake';
import {
  okResult,
  failResult,
  type ActionResult,
...
export type LocalAuthorEchoSnapshot = { displayName: string; avatar?: string };
