...
import type { JoinServerConfirmPreview } from '@/features/layout/useJoinServerConfirmModal';
import type { ServerApplicationModalPayload } from '@/features/layout/useServerApplicationModal';
...
export type AppLayoutModalsProps = {
  ...
  /** When true, server uses the application / waitlist gate for joins. */
  inviteApplicationsEnabled?: boolean;
  /** When false, invite links cannot add new members (Server Settings → Access). */
  inviteJoinLinksEnabled?: boolean;
  /** User can create a hex invite that skips the application gate (MANAGE_GUILD). */
  inviteCanCreateDirectHexInvite?: boolean;
  inviteDirectHexInviteLink?: string;
  inviteDirectHexInviteBusy?: boolean;
  onCreateInviteDirectHex?: () => void | Promise<void>;
  ...
  isJoinServerConfirmModalOpen: boolean;
  joinServerConfirmPreview: JoinServerConfirmPreview | null;
  joinServerConfirmBusy: boolean;
  onUpdateJoinServerConfirmModal: (next: boolean) => void;
  onJoinServerConfirmModalConfirm: () => void;
  isServerApplicationModalOpen: boolean;
  serverApplicationPayload: ServerApplicationModalPayload | null;
...
export const MODALS_INJECT_KEYS = [
  ...
  'inviteDirectHexInviteLink',
  'inviteDirectHexInviteBusy',
  'onCreateInviteDirectHex',
  'inviteableFriends',
  'onUpdateInviteModal',
  'onInviteFriend',
  ...
  'onUpdateJoinServerConfirmModal',
  'onJoinServerConfirmModalConfirm',
