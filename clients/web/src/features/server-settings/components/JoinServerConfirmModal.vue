...
import type { JoinServerConfirmTopMember } from '@/features/layout/useJoinServerConfirmModal';
...
<template>
  <Teleport to="body">
    <div
      v-if="modelValue"
      class="fixed inset-0 z-[170] overflow-x-hidden overflow-y-auto modal-overlay-bg px-3 py-6 sm:px-4"
      @click.self="close"
    >
      <div
      ...
      >
        <div
          ...
          class="join-server-confirm-modal real-glass-modal relative my-auto flex max-h-[min(92dvh,720px)] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-transparent text-foreground shadow-2xl"
        >
