...
import type { MemberProfile } from '@/features/member-profile/memberProfiles';
...
} from '@/features/member-profile/memberPopoutRoleChipStyle';
  ...
  <div class="member-popout__content mt-1 shrink-0 px-4 pb-6">
    ...
    >
      ...
      <ProfileBioText
        ...
        :text="profile.bio"
        body-class="mt-3 text-[13px] leading-5 text-fg-soft"
      />
