...
import { findComposerMarkdownStyleRanges } from '@/features/chat/composerMarkdownDecorations';
...
import { renderMarkdownKatexSafeHtml } from '@/features/chat/markdown/markdownKatex';
