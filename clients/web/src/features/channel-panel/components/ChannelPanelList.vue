...
import ChannelIconPickerPopover from '@/features/channel-settings/ChannelIconPickerPopover.vue';
...
import { isVoiceLikeChannelType } from '@/features/voice/voiceChannelKinds';
