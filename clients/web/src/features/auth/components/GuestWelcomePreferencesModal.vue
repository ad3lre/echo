...
import ActionRailPlacementVisualPicker from '@/features/layout/ActionRailPlacementVisualPicker.vue';
import { ECHO_GUEST_WELCOME_LAYOUT_STORAGE_KEY } from '@/features/auth/guestWelcomeLayout';
