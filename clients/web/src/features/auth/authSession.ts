...
import { clearWorkspaceSessionCache } from '@/features/layout/echoWorkspace/workspaceSessionCache';
import { clearMessageSessionCache } from '@/features/chat/messageSessionCache';
import { clearWarmChannelHeadsForUser } from '@/features/chat/domain/warmChannelHeadCache';
import { clearEchoWorkspaceCache } from '@/features/layout/echoWorkspace/workspacePersistence';
import { markPriorRegistered } from '@/features/layout/priorRegistration';
import {
  setSkipAutoGuestAfterLogout,
  clearSkipAutoGuestAfterLogout,
} from '@/features/layout/boot/autoGuestLogoutSuppress';
import { trackEchoEvent } from '@/features/auth/analytics';
import { clearEchoCsrfMemoryToken } from '@/features/layout/ids/echoCsrf';
import { reportPrimaryFlowFailure } from '@/features/layout/failures/primaryFlowFailure';
import { invalidateInFlightEchoWorkspaceSocialRefresh } from '@/features/layout/echoWorkspace/workspaceSocialRefreshSeq';
