...
vi.mock('@/features/settings/localProfilePersistence', () => ({
...
vi.mock('@/features/layout/echoWorkspace/workspaceSessionCache', () => ({
...
vi.mock('@/features/layout/priorRegistration', () => ({
  markPriorRegistered: mocks.markPriorRegistered,
}));

vi.mock('@/features/layout/boot/autoGuestLogoutSuppress', () => ({
...
vi.mock('@/features/auth/analytics', () => ({
  trackEchoEvent: mocks.trackEchoEvent,
}));

vi.mock('@/features/layout/ids/echoCsrf', () => ({
...
vi.mock('@/features/layout/echoWorkspace/workspaceSocialRefreshSeq', () => ({
