...
struct EchoTotpSetupSheet: View {
  ...
  var body: some View {
    EchoSettingsSheetShell(
      title: EchoCopy.string("Two-factor authentication"),
      description: EchoCopy.string("Add another layer of protection to your Echo account."),
      ...
      content: {
        if secret.isEmpty {
          ...
          EchoSettingAction(
            title: isLoading ? EchoCopy.string("Preparing…") : EchoCopy.string("Begin setup"),
            subtitle: EchoCopy.string("Generate a secret for your authenticator app"),
          ...
          EchoSettingAction(
            ...
            subtitle: EchoCopy.string("Verify the code from your authenticator"),
