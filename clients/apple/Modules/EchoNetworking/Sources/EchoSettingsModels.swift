...
public struct EchoFriendRequestSummary: Decodable, Sendable {
  ...
  public init(incoming: [EchoFriendRequest] = [], outgoing: [EchoFriendRequest] = []) {
...
public struct EchoFriendRequest: Decodable, Sendable, Identifiable {
  ...
  public init(
    ...
    toUserID: String? = nil,
    fromUser: EchoFriendCandidate? = nil
  ) {
    self.id = id
...
public struct EchoAccountIdentity: Decodable, Sendable {
  ...
  /// Last presence the user chose (`online` / `idle` / `do_not_disturb` / `offline`).
  public let status: String?
}
