...
| Client + UI                 | `frontend/src/api/echoClient.ts`, `ServerSettingsPermissionPreviewSection.vue`, `frontend/src/components/EchoDropdown.vue`, `frontend/src/components/ServerSettingsModal.vue`, `frontend/src/features/server-settings/roleManagerFactory.ts` |
