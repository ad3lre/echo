...
- **Server truth:** [`echoPermissionEvaluate.ts`](../../backend/src/domain/echoPermissionEvaluate.ts), [`echoPermissions.ts`](../../backend/src/domain/echoPermissions.ts), [`echoPolicy.ts`](../../backend/src/domain/echoPolicy.ts).
- **Client send / preview choke points:** [`docs/frontend/CHAT_PERMISSIONS_ARCHITECTURE.md`](../frontend/CHAT_PERMISSIONS_ARCHITECTURE.md) — `getSendState` / `executeShellSend`, `chatRolePreviewPermissions.ts`.
