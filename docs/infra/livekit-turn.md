...
- **infra/livekit/livekit.yaml** — `rtc.turn_servers` points at host `coturn` (Docker DNS), same port and credentials.
...
**Full production checklist (topology, secrets, observability):** [`../operations/livekit-production.md`](../operations/livekit-production.md). Example SFU YAML: [`../../infra/livekit/livekit.production.example.yaml`](../../infra/livekit/livekit.production.example.yaml).
