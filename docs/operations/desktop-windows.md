...
| Feature               | Where                                                                                                  | Notes                                                                                                                                                                  |
| --------------------- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| System tray + menu    | [`src-tauri/src/lib.rs`](../../src-tauri/src/lib.rs) (`setup_desktop_tray`)                            | Show Echo, Open Messages, Toggle desktop alerts, Notification settings, Quit. Left-click tray focuses the window.                                                      |
