...
| ------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `GET /workspace`                                              | [`workspace.ts`](../../frontend/src/api/echo/workspace.ts) → [`workspaceEchoApiSnapshot.ts`](../../frontend/src/services/domain/workspaceEchoApiSnapshot.ts)                                   | Structural checks on `servers` + `categoriesByServer` before domain assembly                                                |
| Channel messages, search, pins, read-state, `POST …/messages` | [`messages.ts`](../../frontend/src/api/echo/messages.ts)                                                                                                                                       | Envelope parsers: `messages[]`, `message`, `messageIds[]`, `lastReadMessageId`, post response + optional `idempotentReplay` |
| LiveKit voice session                                         | [`voice.ts`](../../frontend/src/api/echo/voice.ts) `parseEchoLiveKitSessionResponse`                                                                                                           | Explicit `unknown` → required string fields                                                                                 |
| DM threads                                                    | [`social.ts`](../../frontend/src/api/echo/social.ts) → [`echoDmThreadsFromHttp.ts`](../../frontend/src/services/domain/echoDmThreadsFromHttp.ts)                                               | Domain normalizer owns row parsing                                                                                          |
| Invite preview + directory servers                            | [`invitesAndDirectory.ts`](../../frontend/src/api/echo/invitesAndDirectory.ts) → [`echoInvitesAndDirectoryFromHttp.ts`](../../frontend/src/services/domain/echoInvitesAndDirectoryFromHttp.ts) | Domain normalizer                                                                                                           |
| Emoji market packs                                            | [`emoji.ts`](../../frontend/src/api/echo/emoji.ts) → [`echoEmojiMarketPacksFromHttp.ts`](../../frontend/src/services/domain/echoEmojiMarketPacksFromHttp.ts)                                   | Domain normalizer                                                                                                           |
