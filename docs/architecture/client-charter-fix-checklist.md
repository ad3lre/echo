...
- [x] Locked realtime and voice transport boundaries with [`socketInbound.attachDetachParity.test.ts`](../../clients/web/src/features/layout/realtime/socketInbound.attachDetachParity.test.ts) and [`voiceLivekitTransportBoundary.test.ts`](../../clients/web/src/features/voice/voiceLivekitTransportBoundary.test.ts).
