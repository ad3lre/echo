...
- The chat **emoji picker** ([`useEmojiPicker`](../../frontend/src/composables/useEmojiPicker.ts), [`EmojiPopout`](../../frontend/src/components/chat/EmojiPopout.vue)) only surfaces **unicode** categories from [`useEmojiData`](../../frontend/src/composables/useEmojiData.ts). It does not load **server** custom emojis or **subscribed/imported packs**.
...
| Popout mount               | [`EmojiPopout.vue`](../../frontend/src/components/chat/EmojiPopout.vue)                                                                 | Calls `ensureEmojiCategoriesLoaded`, `handleInsert(entry.emoji)` — **unicode only** today |
