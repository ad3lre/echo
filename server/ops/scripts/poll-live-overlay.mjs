 ...
 *
 * Usage:
 *   node server/ops/scripts/poll-live-overlay.mjs set <https-image-url> [--caption "..."] [--ttl-hours 2]
 *   node server/ops/scripts/poll-live-overlay.mjs clear
 *   node server/ops/scripts/poll-live-overlay.mjs status
 */
