 ...
 * and outputs to clients/web/public/twemoji/ (e.g. 1f600.svg -> 1f600.webp).
 *
 * Incremental: when clients/web/public/twemoji/.echo-twemoji-fingerprint.json matches
...
async function copyTwemoji() {
  ...
  console.log(
    'Converted ' +
      converted +
      ' Twemoji SVG files to WebP in clients/web/public/twemoji/',
  );
}
