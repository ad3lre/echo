/**
 * Generates the icons section of clients/web/src/assets/index.ts
...
const iconsDir = path.join(__dirname, '../../../clients/web/src/assets/icons');
...
function main() {
  ...
  const indexPath = path.join(
    __dirname,
    '../../../clients/web/src/assets/index.ts',
  );
