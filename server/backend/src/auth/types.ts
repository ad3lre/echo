export interface AuthUser {
  ...
  /**
   * Profile badges, e.g. `og` for the first {@link ../../contracts/echoAccountBadges.ECHO_OG_BADGE_MAX_SIGNUP_ORDINAL} full accounts.
   * Omitted when the user has none.
   */
  badges?: import('../../../../contracts/echoAccountBadges').EchoPublicBadgeId[];
