...
/** Recompute search flags from the current DB row after server/media/content edits. */
 ...
 *
 * Lives here (not in echoStore/channels/channelReadState.ts) because the conflict-resolution
