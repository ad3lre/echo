...
import type { Embed, Message } from '../../../../../contracts/types';
import { CHANNEL_WEBHOOKS_ENABLED } from '../../../../../contracts/integrationKillSwitches';
import { redactPollOnMessage } from '../../../../../contracts/types';
import {
...
import { canUserSendMassMentionInChannel } from '../../domain/echoStore/members/access';
import { checkEchoServerSpamFilter } from '../../domain/echoStore/servers/serverSpamFilter';
import { evaluateBannedWordsOnMessageSend } from '../../domain/echoStore/bannedWords/messageEval';
import { validateEchoForumPostCreateFirstMessagePoll } from '../../domain/echoStore/community/forums';
...
import { serializeEchoRowForDiscordWebhookExecuteWait } from '../discordBridge/discordWebhookExecuteSerialization';
import {
...
> {
  ...
  let attachments:
    | import('../../../../../contracts/types').MessageAttachmentPayload[]
    | undefined;
  if (hasFiles) {
