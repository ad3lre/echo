...
} from '../../../services/uploads/echoUploadDedupe';
import { sanitizeEchoUploadObjectKeyFragment } from '../../../services/uploads/echoUploadKeyUtils';
import {
...
} from '../../../services/uploads/s3UploadPresign';
import {
  canUserUploadToEchoChannel,
  resolveEchoUploadStorageKey,
} from '../../../services/uploads/echoUploadResolveDest';
import {
...
} from '../../../services/watchTogether/vcWatchTogetherSessions';
import { listVcWatchTogetherUploadLibrary } from '../../../services/watchTogether/vcWatchTogetherLibrary';
import {
  claimVcWatchTogetherChannelHost,
  getVcWatchTogetherChannelHost,
  releaseVcWatchTogetherChannelHost,
} from '../../../services/watchTogether/vcWatchTogetherChannelHost';
import { parseVcWatchTogetherStorageKey } from '../../../../../../contracts/echoUploadStorageKey';
import {
  getLocalUploadPublicPathPrefix,
  resolveLocalUploadFilePath,
  writeLocalEchoUploadFileStream,
} from '../../../services/uploads/localUploadDisk';
import {
  signLocalUploadToken,
  verifyLocalUploadToken,
} from '../../../services/uploads/localUploadToken';
import { consumeLocalUploadTokenOnce } from '../../../services/uploads/localUploadTokenReplay';
...
import { readEchoUploadSourceMetadata } from '../../../services/uploads/echoUploadSourceMetadata';
...
} from '../../../services/uploads/echoUploadServe';
import {
...
import { canUserReadLocalUploadStorageKey } from '../../../services/uploads/echoUploadReadAccess';
import { signMediaCdnUrlsForRequest } from '../../../services/uploads/mediaCdnSign';
import { authUserOrIpRateLimitKey } from '../../rateLimitKeys';
import { echoPool, requireEchoStore } from './routeUtils';
import { isEchoChatUserMediaStorageKey } from '../../../../../../contracts/chatMediaRetention';
import {
...
} from '../../../services/uploads/chatUploadRetention';
import {
  insertEchoUploadIntent,
  markEchoUploadIntentRegistered,
} from '../../../services/uploads/echoUploadIntent';
import { verifyEchoUploadReadyToRegister } from '../../../services/uploads/echoUploadRegister';
import { importChatRemoteImage } from '../../../services/uploads/chatRemoteImageImport';
...
export default async function echoUploadsRoutes(
  ...
  fastify.post<{ Body: { storageKey?: string; publicUrl?: string } }>(
    ...
    async (req, reply) => {
      ...
      const cdnResult = await signMediaCdnUrlsForRequest(req, [{ storageKey }]);
      if (cdnResult.ok) {
        const signed = cdnResult.urls[0]!;
        const tokenMatch = /[?&]t=([^&]+)/.exec(signed.url);
        return reply.code(200).send({
          readToken: tokenMatch?.[1] ?? '',
          url: signed.url,
          expiresAt: signed.expiresAt,
          expiresInSeconds: Math.max(
            1,
            Math.floor((signed.expiresAt - Date.now()) / 1000),
          ),
        });
      }
