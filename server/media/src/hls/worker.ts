 ...
 *
 *   npm run worker:video-hls -w media
 */
import pino from 'pino';
import { config } from '../../../backend/src/config';
import { closePgPool, getPgPool } from '../../../backend/src/db/pg';
import { ensureEchoTables } from '../../../backend/src/db/echoTables';
import { startEchoVideoHlsListen } from './jobs/listen';
import { createEchoVideoHlsScheduler } from './jobs/scheduler';
