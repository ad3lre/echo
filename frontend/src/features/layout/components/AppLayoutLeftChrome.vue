...
<template>
  ...
  <template v-else-if="!stackChrome">
    <div
      ...
      class="app-layout__top-action-rail flex h-[60px] min-h-[60px] w-full min-w-0 shrink-0 items-center overflow-hidden border-b border-border bg-[var(--echo-server-rail-bg)]"
    >
      <ServerList
        layout="horizontal"
