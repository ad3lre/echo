...
import { computed, inject, nextTick, unref, watch } from 'vue';
    ...
    <div class="relative isolate flex min-h-0 min-w-0 flex-1 flex-col">
      ...
      <AppLayoutVoiceSection
        ...
        :open-vc-activity-basketball-stars2026="
          chatCtx.openVcActivityBasketballStars2026
        "
        ...
        :set-vc-activity-codenames-room-url="
          chatCtx.setVcActivityCodenamesRoomUrl
        "
