...
import { computed, nextTick, onUnmounted, ref, watch, withDefaults } from 'vue';
...
<template>
  <div
    class="server-settings-roles-layout flex min-h-0 flex-1 flex-col gap-4 overflow-hidden"
  >
    <div
      class="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden xl:flex-row xl:items-stretch xl:gap-4"
    >
      <div
        id="server-settings-roles-list-panel"
        class="roles-panel roles-panel--left flex min-h-0 w-full max-h-[min(52vh,28rem)] flex-col rounded-2xl p-5 xl:max-h-none xl:max-w-[360px] xl:shrink-0"
      >
                  ...
                  <div class="flex items-center gap-3 min-w-0">
                    ...
                    >
                      <img
                        ...
                        alt=""
                        class="h-3.5 w-3.5 rounded-[4px] object-cover"
                      />
                      <span
                        v-else
      ...
      <div class="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
        ...
        >
          <div class="mb-3 shrink-0 xl:hidden">
            <button
              type="button"
                      ...
                      >
                        ...
                        >
                          ...
                          <button
                            ...
                            :disabled="props.echoRolesLocked"
                            @click="props.removeSelectedRoleLink(idx)"
                          >
                            Remove
                          </button>
                        </li>
