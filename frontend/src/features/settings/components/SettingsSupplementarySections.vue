...
<template>
  ...
  >
    <div class="settings-card rounded-2xl p-5">
      <div class="settings-label">Readability</div>
      <div class="mt-4 flex flex-col gap-3">
        <button
          type="button"
          class="settings-toggle"
          @click="
            form.accessibilitySettings.highContrast =
              !form.accessibilitySettings.highContrast
          "
        >
          <span
            ><span class="block text-sm font-semibold text-foreground"
              >High contrast</span
            ><span class="block text-sm text-muted"
              >Increase contrast in text, borders, and key actions.</span
            ></span
          ><span
            :class="
              form.accessibilitySettings.highContrast
        ...
        <button
          ...
          class="settings-toggle"
          @click="
            form.accessibilitySettings.dyslexiaFriendlyFont =
              !form.accessibilitySettings.dyslexiaFriendlyFont
          "
        >
          <span
            ...
            ><span class="block text-sm text-muted"
              >Swap the main UI font for a more readable alternative.</span
            ></span
          ><span
            :class="
              form.accessibilitySettings.dyslexiaFriendlyFont
    ...
    <div class="settings-card rounded-2xl p-5">
      <div class="settings-label">Motion & Layout</div>
      <div class="mt-4 flex flex-col gap-3">
        <button
          type="button"
          class="settings-toggle"
          @click="
            form.accessibilitySettings.reducedMotion =
              !form.accessibilitySettings.reducedMotion
          "
        >
          <span
            ><span class="block text-sm font-semibold text-foreground"
              >Reduced motion</span
            ><span class="block text-sm text-muted"
              >Tone down transitions, blur shifts, and UI animations.</span
            ></span
          ><span
            :class="
              form.accessibilitySettings.reducedMotion
        ...
        <label class="settings-field"
          ><span class="settings-label">Font scale</span>
          <div class="settings-input">
            <input
              ...
              max="135"
            />
            <div class="mt-2 text-sm text-fg-soft">{{ form.fontScale }}%</div>
          </div></label
        >
      </div>
    </div>
