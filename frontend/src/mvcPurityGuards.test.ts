...
describe('mvc purity guards', () => {
  it('removes misleading compatibility wrappers and duplicate owner files', () => {
    const removedFiles = [
      'frontend/src/services/orchestration/serverPing.ts',
      'frontend/src/services/orchestration/buildDmPanelUserList.ts',
      'frontend/src/services/orchestration/serverVoiceParticipantMerge.ts',
      'frontend/src/services/orchestration/workspaceRosterApply.ts',
      'frontend/src/services/orchestration/workspaceRosterMerge.ts',
      'frontend/src/services/orchestration/workspaceAuthUserRoster.ts',
      'frontend/src/services/orchestration/workspaceSessionApply.ts',
      'frontend/src/stores/messageIndex.ts',
      'frontend/src/features/chat/viewModel/channelMessageIndex.ts',
      'frontend/src/utils/compareRawMessagesChronologically.ts',
      'frontend/src/features/chat/controller/echoHistoryController.ts',
      'frontend/src/features/chat/controller/messageSearchController.ts',
      'frontend/src/features/chat/viewModel/echoHistoryViewModel.ts',
      'frontend/src/features/chat/viewModel/messageSearchViewModel.ts',
      'frontend/src/features/layout/controller/echoWorkspaceLifecycleController.ts',
      'frontend/src/features/layout/viewModel/echoWorkspaceLifecycleViewModel.ts',
      'frontend/src/features/layout/viewModel/echoWorkspaceSessionApply.ts',
      'frontend/src/features/layout/controller/echoWorkspaceSessionController.ts',
      'frontend/src/features/layout/composables/useEchoPresenceSync.ts',
      'frontend/src/features/layout/composables/useGuildChannelTree.ts',
      'frontend/src/features/layout/composables/serverVoiceParticipantMerge.ts',
      'frontend/src/features/server-settings/roleManagerFactory.ts',
      'frontend/src/features/chat/domain/echoInvitePreview.ts',
      'frontend/src/features/chat/domain/postDiscordChannelImportMessages.ts',
      'frontend/src/features/chat/domain/serverEmojiLibrary.ts',
      'frontend/src/features/server-settings/domain/fetchManagedRolesFromEcho.ts',
    ];
