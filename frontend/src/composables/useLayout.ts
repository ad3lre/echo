...
export function useLayout() {
  ...
  /**
   * When true, narrow-viewport auto-collapse and AppLayout main-width auto-collapse
   * must not hide the member list — the user explicitly opened it.
   * Cleared when the user collapses, drags the panel closed, or the window is no longer "narrow".
   */
