 ...
 * related helpers in `@/domain/chatRolePreviewPermissions` simulate “what this draft role could do”
...
} from '@/domain/chatRolePreviewPermissions';
import {
  attemptFlags as domainAttemptFlags,
  getOutgoingBlockReasonDomain,
  type OutgoingContentType,
} from '@/services/domain/permissions';
import { formatOutgoingBlockReason } from '@/ui/permissions/outgoingBlockReasonText';
