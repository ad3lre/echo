    ...
    >
      ...
      >
        ...
        <div class="min-w-0 flex-1">
          ...
          <p class="truncate text-[11px] leading-snug text-fg-subtle">
            <span class="text-fg-soft">{{ card.serverName }}</span>
            <span class="mx-1 text-fg-subtle/80" aria-hidden="true">·</span>
