...
.echo-dropdown-container:not(.echo-dropdown--server) .echo-dropdown-trigger {
  background: var(--vue-auto-054);
  box-shadow: inset 0 0 0 1px var(--vue-auto-005);

  &:hover {
    background: var(--vue-auto-007);
    box-shadow: inset 0 0 0 1px var(--vue-auto-003);
  }

  &.echo-dropdown-trigger--open {
    box-shadow: inset 0 0 0 1px var(--vue-auto-129);
    background: var(--vue-auto-007);
  }
}
