...
const {
  ...
  onListedInDirectoryEnabledChange,
  serverIconUrl,
  ...
  <Transition name="server-settings-modal">
    ...
    >
      <div
        ...
        class="server-settings-modal relative w-full overflow-hidden text-white"
        :class="
          isCompactShell
            ? 'flex h-[100dvh] max-w-none flex-col rounded-none'
            : 'flex h-[min(920px,96vh)] max-w-7xl rounded-2xl'
        "
                ...
                <template v-if="activeSection === 'Overview'">
                  <ServerSettingsOverviewSection
                    ...
                    @update:banner-blackout-enabled="
                      onBannerBlackoutEnabledChange
                    "
                    @update:listed-in-directory-enabled="
                      onListedInDirectoryEnabledChange
                    "
