...
vi.mock('@/components/chat/PendingMediaPreview.vue', () => ({
  default: { template: '<div />' },
}));

vi.mock('@/components/chat/EmojiPopout.vue', () => ({
  default: { template: '<div />' },
}));

vi.mock('@/components/chat/GifPopout.vue', () => ({
  default: { template: '<div />' },
}));

vi.mock('@/components/chat/AttachPopout.vue', () => ({
  default: { template: '<div />' },
}));

vi.mock('@/components/chat/PollCreateModal.vue', () => ({
  default: { template: '<div />' },
}));

vi.mock('@/components/chat/ImageViewerModal.vue', () => ({
  default: { template: '<div />' },
}));
