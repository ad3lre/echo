...
function accentFromEmbed(embed: Embed): string {
  ...
  if (u.includes('youtube.com') || u.includes('youtu.be')) return '#ff0000';
  if (u.includes('vimeo.com')) return '#1ab7ea';
  if (u.includes('twitter.com') || u.includes('x.com')) return '#1d9bf0';
  return '#3ba55d';
}
