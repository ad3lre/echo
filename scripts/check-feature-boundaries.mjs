 ...
 *
 * Echo's frontend is organised into feature modules under frontend/src/features/.
 ...
 *   node scripts/generate-feature-boundaries-allowlist.mjs --write
 *
...
function resolveSpecifier(spec, fromFileAbs) {
  let abs;
  if (spec.startsWith('@/'))
    abs = path.join(repoRoot, 'frontend', 'src', spec.slice(2));
