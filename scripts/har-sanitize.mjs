...
function printUsage() {
  process.stdout.write(
    [
      'Usage:',
      '  node scripts/har-sanitize.mjs <input.har> [--out-dir <dir>] [--max-body <bytes>] [--aggressive]',
      '',
      'Example:',
      '  node scripts/har-sanitize.mjs ../chat-echo.com.har --out-dir ./artifacts/har-clean --aggressive',
      '',
    ].join('\n'),
  );
}
