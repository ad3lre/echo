#!/usr/bin/env bash
set -euo pipefail
# Install echo-recovery-watcher systemd unit (see infra/systemd/README.md).
# Usage: sudo ./scripts/deploy/install-recovery-watcher.sh
...
echo "  tail -f ${ROOT}/logs/vps/echo-recovery-watcher.log"
