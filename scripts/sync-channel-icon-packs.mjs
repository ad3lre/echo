 ...
 * frontend/src/assets/icons/ with math- and hobby- prefixes.
 *
 * Run: node scripts/sync-channel-icon-packs.mjs
...
const iconsOutDir = path.join(repoRoot, 'frontend/src/assets/icons');
