 ...
 *
 *   node scripts/generate-feature-boundaries-allowlist.mjs          # preview counts
 *   node scripts/generate-feature-boundaries-allowlist.mjs --write  # write the file
 */
...
const OUT = path.join(repoRoot, 'scripts', 'feature-boundaries-allowlist.json');
